...
from apps.stopwatch.stopwatch import Stopwatch
from apps.stopwatch.stopwatch_database import StopwatchTable, ProjectTable
from apps.stopwatch.stopwatch_app_addentry import AddStopwatchPopup
